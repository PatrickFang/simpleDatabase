...
Dir.mkdir path_to_data       #comment out if need persistency
Dir.mkdir path_to_data_count #comment out if need persistency
...
FileUtils.rm_rf(path_to_data)       #comment out if need persistency
FileUtils.rm_rf(path_to_data_count) #comment out if need persistency
